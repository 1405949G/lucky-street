/**
 * games/good-vs-evil/server/config.js - Good vs Evil config
...
export const ALLOWED_TRANSITIONS = Object.freeze({
  ...
  [PHASES.TEAM_VOTE_REVEAL]: ['RESOLVE_TEAM_VOTE', 'ACK_TEAM_VOTE_REVEAL'],
  [PHASES.QUEST_VOTE]: ['SUBMIT_QUEST_VOTE', 'FORCE_QUEST_REVEAL'],
  [PHASES.QUEST_REVEAL]: ['RESOLVE_QUEST', 'ACK_QUEST_REVEAL'],
