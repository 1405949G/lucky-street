    ...
    <div className="rounded-[22px] glass-lantern p-4 relative overflow-hidden">
      ...
      <form onSubmit={submit} className="mt-3 flex gap-2">
        <input
          ...
          placeholder="A1B2"
          maxLength={4}
          className="flex-1 px-3.5 py-3 rounded-2xl bg-white/[0.07] border border-white/15 text-white placeholder:text-white/25 font-mono font-[900] tracking-[0.22em] text-center uppercase outline-none focus:border-[#c9734b]/30 focus:bg-white/[0.09] backdrop-blur"
        />
