        ...
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <span className="hidden sm:inline-flex items-center gap-1 px-2 py-1 rounded-full bg-[#1e2326] border border-white/10 text-[11px] font-bold text-white/60">
            ...
            <p className="text-xs text-white/62 mt-1.5 flex items-center gap-1.5 flex-wrap">
              <span className="inline-flex items-center gap-1"><span className="w-5 h-5 rounded-full bg-[#23272a] border border-white/10 flex items-center justify-center text-[10px] leading-none">👑</span><span className="font-bold text-white/90">{room.hostName}</span></span>
          ...
          <div className="text-right shrink-0">
            ...
            <div className="mt-1.5 h-1.5 w-[92px] rounded-full bg-[#23272a] overflow-hidden p-0.5">
