      ...
      <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center justify-between">
        <div>
          <div className="flex items-center gap-3">
            ...
            <span className="hidden sm:inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-amber-400/15 border border-amber-400/20 text-amber-200 text-[11px] font-black tracking-widest">{filtered.length} rooms</span>
          </div>
      ...
      <div className="mt-5 grid grid-cols-1 lg:grid-cols-[1.28fr_0.72fr] gap-5 items-start">
        <div className="space-y-3">
          <div className="flex gap-2">
            ...
            <span className="hidden sm:inline-flex px-3.5 py-2 rounded-2xl bg-white/[0.06] border border-white/10 text-xs font-black tracking-widest text-amber-200/70 items-center">{filtered.length} rooms</span>
          </div>
          ...
          {filtered.length === 0 ? (
            <div className="rounded-[24px] glass-lantern p-8 text-center overflow-hidden relative">
              ...
              <div className="relative">
                ...
                <button onClick={onCreateClick} className="mt-4 px-5 py-2.5 rounded-full bg-gradient-to-br from-[#fde68a] to-[#fbbf24] text-[#0e2533] text-sm font-black">New Game</button>
              </div>
            </div>
          ) : (
        ...
        <div className="space-y-4 lg:sticky lg:top-[84px]">
          ...
          <div className="rounded-[22px] glass-lantern p-5 relative overflow-hidden">
            ...
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-[900] text-[#fffbeb] tracking-wide">Quick tips</h3>
            </div>
            <ul className="text-sm text-white/68 mt-3 space-y-2.5">
              <li className="flex gap-2"><span className="text-amber-300 mt-0.5">•</span><span>Your name stays saved for next time.</span></li>
              <li className="flex gap-2"><span className="text-amber-300 mt-0.5">•</span><span>Pick a unique name — try another if taken.</span></li>
              <li className="flex gap-2"><span className="text-amber-300 mt-0.5">•</span><span>Share your invite link to play together.</span></li>
            </ul>
            <div className="mt-4 px-3 py-2.5 rounded-xl bg-amber-400/10 border border-amber-400/15 flex items-center gap-2">
              ...
              <p className="text-xs font-bold text-amber-200/90">Tip: open on TV, friends join on phones</p>
            </div>
